          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 leading-relaxed">
                ...
                Seguro, transparente y fácil de usar.
              </p>
            </div>
            
            {/* Columna 2: Enlaces */}
            <div>
              <h3 className="text-lg font-bold mb-3 text-blue-400">Acerca de</h3>
            ...
            <div>
              <h3 className="text-lg font-bold mb-3 text-blue-400">Desarrolladores</h3>
              <ul className="space-y-2 text-sm text-gray-300">
                <li>• Ronny Villa</li>
